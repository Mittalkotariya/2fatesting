...
<div id="mo_2fa_features_only" style="display: block;">	
	...
	<div class="mo_wpns_upgrade_title11"  >
        ...
        <?php }else{ 
        		?>
				<button class="mo_wpns_button mo_wpns_button1 mo_wpns_upgrade_page_button"  onclick="mo2f_register_and_upgradeform('wp_2fa_basic_plan', '2fa_plan')">Upgrade</button>
			<?php } 
...
<div id="mo_2fa_lite_features_only" style="display: none;">	
	...
	<div class="mo_wpns_upgrade_title_2fa_lite"  >
		<div class="mo_wpns_upgrade_page_title_name">
			<h1 class="mo_wpns_upgrade_page_2fa_integration_plan_name">Custom Forms
