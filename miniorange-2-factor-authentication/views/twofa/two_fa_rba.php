        ...
        <form id="settings_from_addon" method="post" action="">
            <input type="hidden" name="option" value="mo_auth_addon_settings_save"/>
                    <h1><?php echo mo2f_lt( '1. Remember Device' ); ?>
                     <span style="text-align: right;font-size: large;"><?php echo '<a href="'.$addons_url     .'" style="color: red">'; ?>[ PREMIUM ]</a></span><a href="https://developers.miniorange.com/docs/security/wordpress/wp-security/remember-my-device" target="_blank">
