<?php 
        ...
        <div class="mo_wpns_setting_layout">
            ...
            <div id="mo2f_hide_shortcode_content" >
                ...
                <h3><?php echo __( 'List of Shortcodes', 'miniorange-2-factor-authentication' ); ?><a href="https://developers.miniorange.com/docs/security/wordpress/wp-security/Shortcodes" target="_blank"><span class="dashicons dashicons-text-page" style="font-size:19px;color:#269eb3;float: right;"></span></a></h3>
