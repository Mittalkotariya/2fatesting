...
function prompt_user_to_select_2factor_mthod_inline($current_user_id, $login_status, $login_message,$redirect_to,$session_id){
                    ...
                    <div class="mo_customer_validation-modal-dialog mo_customer_validation-modal-md">
                        <div class="login mo_customer_validation-modal-content">
                            ...
                            <div class="mo2f_modal-body">
                                <?php echo __('<b> Choose Any Two-Factor method to protect your account</b>', 'miniorange-2-factor-authentication');
                                if(isset($_SESSION['mo2f-login-message']) && !empty($_SESSION['mo2f-login-message'])) {  ?>
                                    <div  id="otpMessage">
                                ...
                                <span class="<?php if( !(in_array("GOOGLE AUTHENTICATOR", $opt))  ){ echo "mo2f_td_hide"; }else { echo "mo2f_td_show"; }?>">
                                    ...
                                    <?php echo __('Google Authenticator/Authy/Microsoft Authenticator<br> &nbsp;&nbsp;&nbsp; &nbsp;
                                ...
                                <br><a href="#skiptwofactor" style="color:#F4D03F ;font-weight:bold;margin-left:5%;"><?php echo __('Skip Two Factor', 'miniorange-2-factor-authentication'); ?></a>>>
                            <?php } ?>
                                <br /><br />
...
function prompt_user_for_miniorange_app_setup($current_user_id, $login_status, $login_message){ 
    ...
    if(! MO2f_Utility::check_if_email_is_already_registered( $email ) or 1)
    {
        ...
        if(json_last_error() == JSON_ERROR_NONE){
            if($check_user['status'] == 'ERROR'){
                ...
                $Mo2fdbQueries->update_user_details( $current_user_id, array( "mo2f_user_email" => '' ) );
                ...
                update_option(base64_encode("totalUsersCloud"),get_option(base64_encode("totalUsersCloud"))+1);
                ...
                <div class="mo2f_modal-dialog mo2f_modal-lg" >
                    <div class="login mo_customer_validation-modal-content">
                        ...
                        <div class="mo2f_modal-body">
                            ...
                            <?php } ?>
                                    <div class="mcol-1">
                                         <div style="font-size: 18px !important;"><?php echo __('Configure Google Authenticator.', 'miniorange-2-factor-authentication'); ?></div>
                                            <ol>
                                                ...
                                                <br>
                                                    <?php if(MO2F_IS_ONPREM){ ?>
                                                         ...
                                                         <div style="margin-top: 70%"><a href="#mo2f_scanbarcode_a" aria-expanded="false" style="color:#21618C;"><b><?php echo __('Can\'t scan the barcode?', 'miniorange-2-factor-authentication'); ?></b></a></div>
                                                    <?php 
            ...
            <div class="mo2f_modal" tabindex="-1" role="dialog" id="myModal5">
                ...
                <div class="mo2f_modal-dialog mo2f_modal-lg">
                    <div class="login mo_customer_validation-modal-content">
                        <div class="mo2f_modal-header">
                            <h4 class="mo2f_modal-title"><button type="button" class="mo2f_close" data-dismiss="modal" aria-label="Close" title="<?php echo __('Back to login','miniorange-2-factor-authentication');?>" onclick="mologinback();"><span aria-hidden="true">&times;</span></button>
                            <?php echo __('Connect with miniOrange', 'miniorange-2-factor-authentication'); ?></h4>
                        </div>
                        <div class="mo2f_modal-body">
                            <?php if(isset($login_message) && !empty($login_message)){ ?>
                                    <div  id="otpMessage">
                            ...
                            <form name="mo2f_inline_register_form" id="mo2f_inline_register_form" method="post" action="">
                                ...
                                <p>2FA methods- Push Notification, QR code Auhthentication, OTP over SMS and SOFT Token needs your account with miniOrange.</p>
                ...
                <form name="f" id="mo2f_inline_login_form" method="post" action="" hidden>
                    <p><b>It seems you already have an account with miniOrange. Please enter your miniOrange email and password.<br></b><a target="_blank" href="https://login.xecurify.com/moas/idp/resetpassword"> Click here if you forgot your password?</a></p>
                            ...
                            <br>
                            <input type="button" name="back" id="mo2f_inline_back_btn" class="miniorange_button" value="<?php echo __('<< 2FA Menu', 'miniorange-2-factor-authentication'); ?>" />
                            <?php mo2f_customize_logo() ?>
                        </div>
                    </div>
                </div>
